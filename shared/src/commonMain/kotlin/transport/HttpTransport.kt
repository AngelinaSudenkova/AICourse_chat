...
import models.WikiFetchRequest
import models.WikiArticleMeta
import models.WikiIndexRequest
...
class HttpTransport(
    ...
    suspend fun fetchWikiArticle(request: WikiFetchRequest): WikiArticleMeta {
        return try {
            val response = client.post("/api/wiki/fetch") {
                setBody(request)
            }
    ...
    suspend fun indexWikiArticles(request: WikiIndexRequest): WikiIndex {
        return try {
            val response = client.post("/api/wiki/index") {
                setBody(request)
            }
    ...
    suspend fun searchWiki(request: WikiSearchRequest): WikiSearchResponse {
        return try {
            val response = client.post("/api/wiki/search") {
                setBody(request)
            }
    ...
    suspend fun getRagWithCitations(request: RagCitedAnswerRequest): RagCitedAnswerResponse {
        return try {
            val response = client.post("/api/rag/cited") {
                setBody(request)
            }
    ...
    suspend fun ragChat(request: RagChatRequest): RagChatResponse {
        return try {
            val response = client.post("/api/rag/chat") {
                setBody(request)
            }
